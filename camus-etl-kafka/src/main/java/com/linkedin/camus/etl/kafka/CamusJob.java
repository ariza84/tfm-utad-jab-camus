...
public class CamusJob extends Configured implements Tool {
    ...
    private final DateTimeFormatter dateFmt = DateUtils.getDateTimeFormatter(
            "YYYY-MM-dd-HH-mm-ss", DateTimeZone.forID("Europe/Madrid"));
    ...
    public void run() throws Exception {
        ...
        date = DateUtils.getDateTimeFormatter("YYYY-MM-dd-HH-mm-ss", DateTimeZone.forID("Europe/Madrid"));
        String executionDate = new DateTime().toString(date);
